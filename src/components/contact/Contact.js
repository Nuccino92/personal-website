    ...
    >
      <div className="contact-me">
        ...
        <form>
          ...
          <textarea cols={11} rows={22} name="message" placeholder="message" />
          <button onClick={handleClick} className="btn draw-border">
            Send A Message
          </button>
        </form>
        <div class="custom-shape-divider-top-1649466898">
          <div class="custom-shape-divider-top-1649532422">
            <svg
              data-name="Layer 1"
